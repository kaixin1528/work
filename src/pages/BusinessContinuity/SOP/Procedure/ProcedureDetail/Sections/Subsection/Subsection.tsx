...
const Subsection = ({
  ...
  return (
    <article className="grid content-start gap-3 p-4 bg-gradient-to-r dark:from-checkbox/70 dark:to-white/10  border-l-1 dark:border-black/60 rounded-2xl">
      ...
      <section className="grid content-start grid-cols-2 gap-10 w-full">
        {subsection.content && (
          <SubsectionContent
