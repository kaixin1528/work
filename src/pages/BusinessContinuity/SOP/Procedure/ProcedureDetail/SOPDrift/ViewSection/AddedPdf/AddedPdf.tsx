...
import "./style/AddedHighlight.css";
import Loader from "src/components/Loader/Loader";
import AddedHighlight from "./AddedHighlight";
...
const AddedPdf = ({ url, highlights }: { url: string; highlights: any[] }) => {
