...
import { RemoveVendorResponse } from "src/services/third-party-risk/vendors-and-partners/vendors";

const DeleteVendorResponse = ({
  vendorID,
  questionID,
}: {
  vendorID: string;
  ...
  const removeResponse = RemoveVendorResponse(vendorID, questionID);

  const deleting = removeResponse.status === "loading";
...
export default DeleteVendorResponse;
