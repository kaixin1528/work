...
import { GetVendorAssessments } from "src/services/third-party-risk/vendors-and-partners/vendors";

const Assessments = ({ vendorID }: { vendorID: string }) => {
  ...
  const { data: reviewList, status: reviewStatus } = GetVendorAssessments(
    vendorID,
    sort,
    pageNumber,
    "VENDOR"
  ...
  return (
    <section className="flex flex-col flex-grow gap-5">
      <h4 className="text-lg">Assessments</h4>
      {reviewStatus === "loading" ? (
        ...
        <section className="flex items-center place-content-center gap-10 w-full h-full">
          ...
          <article className="grid gap-3">
            <h4 className="text-xl font-extrabold">Assessments</h4>
