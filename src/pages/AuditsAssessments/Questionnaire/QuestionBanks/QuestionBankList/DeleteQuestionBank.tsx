...
import { RemoveQuestionBank } from "src/services/audits-assessments/questionnaire";
...
const DeleteQuestionBank = ({
  ...
  const removeQuestionBank = RemoveQuestionBank();
  const deleting = removeQuestionBank.status === "loading";
        ...
        <section className="grid gap-5">
          ...
          <section className="flex items-center gap-5 mx-auto text-sm">
            ...
            <button
              ...
              onClick={() => {
                removeQuestionBank.mutate({
                  questionBankID: selectedQuestionBank.document_id,
                });
                handleOnClose();
              }}
            >
