...
import { RemoveQAPair } from "src/services/audits-assessments/questionnaire";
...
const DeleteQAPair = ({
  ...
  const removeQAPair = RemoveQAPair(questionBankID);

  const deleting = removeQAPair.status === "loading";
